...
@Component
@AllArgsConstructor
public class SectionWithPointsDTOMapper implements Function<Section, SectionWithPointsDTO> {
    private PointDTOMapper pointDTOMapper;

    @Override
    public SectionWithPointsDTO apply(Section section) {
        if (section == null) {
            return null;
        }

        return new SectionWithPointsDTO(
