...
import eus.ehu.tfg.ktoda.tollsystem.section.dto.SectionWithFeesDTOMapper;
...
public class TransactionDTOMapper implements Function<Transaction, TransactionDTO> {
    private final SectionSimpleDTOMapper sectionSimpleDTOMapper;
    ...
    public TransactionDTO apply(Transaction transaction) {
        ...
        return new TransactionDTO(
                ...
                sectionSimpleDTOMapper.apply(transaction.getSection())
        );
    }
}
